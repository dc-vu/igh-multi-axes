...
static unsigned int tar_tor    ;
// static unsigned int max_torq    ;
static unsigned int tar_pos    ;
static unsigned int mode_ope    ;
static unsigned int mode_ope_dis    ;
...
const static ec_pdo_entry_reg_t domain_r_regs[] = 
{
        ...
        {servo1,servo1_code,0x6071,00,&tar_tor                },
        {servo1,servo1_code,0x6060,00,&mode_ope                },
        {}
};
...
const static ec_pdo_entry_reg_t domain_w_regs[] = 
{
        ...
        {servo1,servo1_code,0x6077,00,&pos_act                },
        {servo1,servo1_code,0x6061,00,&mode_ope_dis           },
        {}
};
...
void cyclic_task()
{
	...
	while(1) 
	{
        ...
        else if( (temp[0]&0x006f) == 0x0027)        // this servo is on
		{
            ...
            move_value =   700 * sin(2 * 3.14159 * 0.5 * t); // simulate a sine wave position
            // move
