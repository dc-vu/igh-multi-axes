...
const static ec_pdo_entry_reg_t domain_r_regs[] = 
{
        ...
        {servo1,servo1_code,0x60ff,00,&tar_pos[0]                },
        {servo2,servo2_code,0x60ff,00,&tar_pos[1]                },
        {servo3,servo3_code,0x60ff,00,&tar_pos[2]                },
        {servo4,servo4_code,0x60ff,00,&tar_pos[3]                },
        {servo5,servo5_code,0x60ff,00,&tar_pos[4]                },
        {servo6,servo6_code,0x60ff,00,&tar_pos[5]                },
...
int main(int argc, char **argv)
{
    ...
    if (ecrt_slave_config_sdo8(sc1, 0x6060, 0, 9))
    {
        return -1;
    }
    ...
    if (ecrt_slave_config_sdo16(sc1, 0x1C12, 01, 0x1600))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo16(sc1, 0x1C13, 01, 0x1A00))
    {
        return -1;
    }


    if (ecrt_slave_config_sdo8(sc2, 0x6060, 0, 9))
    {
        return -1;
    }
    ...
    if (ecrt_slave_config_sdo16(sc2, 0x1C12, 01, 0x1600))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo16(sc2, 0x1C13, 01, 0x1A00))
    {
        return -1;
    }


    if (ecrt_slave_config_sdo8(sc3, 0x6060, 0, 9))
    {
        return -1;
    }
    ...
    if (ecrt_slave_config_sdo16(sc3, 0x1C12, 01, 0x1600))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo16(sc3, 0x1C13, 01, 0x1A00))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo8(sc4, 0x6060, 0, 9))
    {
        return -1;
    }
    ...
    if (ecrt_slave_config_sdo16(sc4, 0x1C12, 01, 0x1600))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo16(sc4, 0x1C13, 01, 0x1A00))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo8(sc5, 0x6060, 0, 9))
    {
        return -1;
    }
    ...
    if (ecrt_slave_config_sdo16(sc5, 0x1C12, 01, 0x1600))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo16(sc5, 0x1C13, 01, 0x1A00))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo8(sc6, 0x6060, 0, 9))
    {
        return -1;
    }
    ...
    if (ecrt_slave_config_sdo16(sc6, 0x1C12, 01, 0x1600))
    {
        return -1;
    }

    if (ecrt_slave_config_sdo16(sc6, 0x1C13, 01, 0x1A00))
    {
        return -1;
    }
